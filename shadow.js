...
var session = conf.session.replace(/BWM-MD;;;/g,"");
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ Dark-Shadow Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Dark Shadow Md is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading Dark Shadow Commands ...\n");
...
💠 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 :𝑷𝒂𝒕𝒉𝒖𝒎 𝑴𝒂𝒍𝒔𝒂𝒓𝒂
💠 𝑼𝒔𝒆 : [ ${prefixe} 
💠 𝑪𝒎𝒅 : ${evt.cm.length}︎

 
> 𝑱𝒐𝒊𝒏 𝒘𝒂𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒇𝒐𝒓 𝒃𝒐𝒕 𝒖𝒑𝒅𝒂𝒕𝒆𝒔
https://whatsapp.com/channel/0029VacTVYIGOj9kr0GJzR1r

> 𝑭𝒐𝒓 𝒎𝒐𝒓𝒆 𝒊𝒏𝒇𝒐 𝒕𝒂𝒑 𝒐𝒏 𝒕𝒉𝒆 𝒍𝒊𝒏𝒌 𝒃𝒆𝒍𝒐𝒘
  https://github.com/dark-shadow-LK/-
