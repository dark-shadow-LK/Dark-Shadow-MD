...
france({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `*Dark_Shadow-MD VIDEO'S*\n\n*Title :* ${Element.title}
*Duration :* ${Element.timestamp}
*Video Url:* ${Element.url}



*Made by Pathum Malsara*\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*Dark_Shadow-MD*", gifPlayback: false }, { quoted: ms });
      });
